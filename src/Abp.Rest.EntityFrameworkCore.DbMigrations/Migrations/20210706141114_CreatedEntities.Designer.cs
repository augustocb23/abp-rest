...
namespace Abp.Rest.Migrations
{
    ...
    [Migration("20210706141114_CreatedEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Rest.Orders.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Abp.Rest.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Abp.Rest.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Abp.Rest.Orders.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Abp.Rest.Orders.Order", b =>
                {
                    b.HasOne("Abp.Rest.Orders.Client", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("Abp.Rest.Orders.OrderItem", b =>
                {
                    b.HasOne("Abp.Rest.Orders.Order", null)
                        .WithMany("Items")
                        .HasForeignKey("OrderId");

                    b.HasOne("Abp.Rest.Orders.Product", "Product")
                        .WithMany()
